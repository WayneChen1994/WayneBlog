...
env.roledefs = {
    'myserver': ['wayne-chen@127.0.0.1'],
}
env.PROJECT_NAME = 'WayneBlog'
env.SETTINGS_BASE = 'WayneBlog/WayneBlog/settings/base.py'

env.DEPLOY_PATH = '/Users/wayne/PythonVenv/WayneBlog'
...
def build(version=None):
    ...
    with settings(warn_only=True):
        local('python setup.py bdist upload -r internal')
